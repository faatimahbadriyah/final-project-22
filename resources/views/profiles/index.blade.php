        ...
        <div class="card-body">
            ...
            <tr>
                ...
                <tbody>
                    ...
                    <tr>
                        <th rowspan="2" scope="row" class="image text-center" width="160px">
                            <img src="{{asset('storage/profiles/'.$value->photo)}}"
                                class="img-circle elevation-4 img-fluid" alt="User Image"
                    ...
                    <tr>
                        <td colspan="3" align="center">
                            ...
                            <a href="{{route('profiles.edit', ['profile'=>$value->id])}}"
                                class="btn btn-primary btn-lg">Edit profil</a>
